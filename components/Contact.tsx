  ...
  return (
    <section id="contact" className="py-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
        ...
        {/* Left Card */}
        <div className="reveal delay-1 spin-card bg-slate-800 rounded-xl hover:scale-[1.02] transition-all duration-300 h-full">
          <div className="p-6 rounded-xl bg-slate-800 space-y-6 h-full flex flex-col justify-start">
        ...
        {/* Right Card */}
        <div className="reveal delay-2 h-full">
          <ContactForm />
        </div>
