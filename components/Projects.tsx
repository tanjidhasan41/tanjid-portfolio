const projects = [
  {
    ...
    description: "End-to-end automation framework for the nopCommerce e-commerce platform using Playwright. Covers authentication, product management, cart functionality, and UI validations.",
  ...
  },
  {
    ...
    description: "Automated web testing framework built with Playwright for validating critical business workflows and UI functionality.",
  ...
  },
  {
    ...
    description: "Mobile automation framework developed using Appium for Android application testing, covering user interactions, validations and regression scenarios.",
  ...
  },
  {
    ...
    description: "Selenium automation framework following Page Object Model architecture with TestNG reporting and reusable test components.",
  ...
  },
  {
    ...
    description: "REST API automation project using Rest Assured for request validation, response verification and API workflow testing.",
  ...
  },
  {
    ...
    description: "Performance testing project designed to evaluate application stability, response time and scalability under load.",
  ...
  },
  {
    ...
    description: "API testing and workflow validation project using Postman and Newman. Covers transaction flows, authentication and data validation.",
    ...
    <section id="projects" className="py-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {projects.map((project, i) => (
          <div
            key={project.title}
            className={`reveal delay-${(i % 4) + 1} bg-slate-800 p-5 rounded-xl border border-slate-700 hover:border-sky-400 hover:scale-[1.02] transition-all duration-300 flex flex-col`}
          >
            ...
            <div className="flex flex-wrap gap-1.5 mb-4">
              {project.tech.map((item) => (
                <span key={item} className="bg-violet-500/10 border border-violet-500/30 text-violet-300 px-2.5 py-0.5 rounded-full text-xs font-medium">
                  {item}
                </span>
              ))}
            </div>
